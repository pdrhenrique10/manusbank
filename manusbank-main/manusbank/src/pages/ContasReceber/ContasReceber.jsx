...
// conversão. formatValorNaMoeda é o padrão pra itens individuais.
...
function ContasReceber() {
  ...
  // 👇 Sem conversão: a moeda é fixa por conta, então todo item já
  // está na mesma moeda. Somamos e exibimos direto.
